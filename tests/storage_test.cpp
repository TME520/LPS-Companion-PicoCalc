...
int main(){
    ...
    dated.key('9');dated.key(Enter);assert(dated.data().today.date.year==2028&&dated.data().today.date.month==3&&dated.data().today.date.day==1);
    ...
    dated.key(Escape);dated.key('9');std::remove("2028-03-01_LPS-Companion.ics");
